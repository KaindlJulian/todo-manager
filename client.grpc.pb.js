...
goog.provide('proto.todo.TodoServiceClient');
goog.provide('proto.todo.TodoServicePromiseClient');

goog.require('grpc.web.GrpcWebClientBase');
goog.require('grpc.web.AbstractClientBase');
goog.require('grpc.web.ClientReadableStream');
goog.require('grpc.web.Error');
goog.require('proto.todo.Empty');
goog.require('proto.todo.Todo');
goog.require('proto.todo.TodoIdRequest');
goog.require('proto.todo.TodoList');
